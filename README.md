...
この thinreports-generator は thinreports/thinreports-generator をフォークし、section-report 形式のサポートを追加したバージョンです。section-report 形式の詳細は [README_FOR_SECTION_REPORT.md](README_FOR_SECTION_REPORT.md) を参照してください。
