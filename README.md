...
この thinreports-generator は thinreports/thinreports-generator をフォークし、section-report 形式のサポートを追加したバージョンです。その section-report 形式は [Thinreports コミュニティの機能コンセプト](https://github.com/thinreports/thinreports/issues/7) をベースに実装されています。

また、私たちは、この section-report 形式を Thinreports コミュニティに提案し、thinreports-generator に取り込まれることを目指しています。

## SectionReport 形式

便宜上、thinreports の元の形式を basic-report 形式と呼称します。

section-report 形式はその basic-report 形式とは異なる新しいテンプレート形式です。これは次のような特徴を持っています。
